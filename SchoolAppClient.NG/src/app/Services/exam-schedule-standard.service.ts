...
export class ExamScheduleStandardService {
  ...
  //public UpdateExamScheduleStandards(examScheduleStandard: UpdateExamScheduleStandardVM): Observable<any> {

  //  return this.http.put<any>(this.apiUrl + '/' + examScheduleStandard.ex, employee, this.httpOptions);
  //}
